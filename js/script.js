...
$('.help_title ul li ').click(function(){
  
  $('.help_title ul li ').removeClass('active')
  $('.help_item').find('.help_item_txt').slideUp()

  $(this).addClass('active')
  $( $(this).find('a').attr('href') ).find('.help_item_txt').slideDown()
